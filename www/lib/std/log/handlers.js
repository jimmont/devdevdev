...
var WriterHandler = /** @class */ (function (_super) {
    ...
    WriterHandler.prototype.log = function (msg) {
        this._writer.write(this._encoder.encode(msg + "\n"));
    };
    return WriterHandler;
}(BaseHandler));
export { WriterHandler };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, open(this._filename, "a")];
                    case 1:
                        // open file in append mode - write only
                        _a._file = _b.sent();
    ...
    FileHandler.prototype.destroy = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._file.close()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }

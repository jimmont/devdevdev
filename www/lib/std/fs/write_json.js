...
export function writeJson(filePath, object, options) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Deno.writeFile(filePath, new TextEncoder().encode(contentRaw))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
//# sourceMappingURL=write_json.js.map
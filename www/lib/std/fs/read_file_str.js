...
export function readFileStrSync(filename, opts) {
    if (opts === void 0) { opts = {}; }
    var decoder = new TextDecoder(opts.encoding);
 ...
 * @param opts Read options
 */
export function readFileStr(filename, opts) {
    if (opts === void 0) { opts = {}; }
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    decoder = new TextDecoder(opts.encoding);
                    _b = (_a = decoder).decode;
                    return [4 /*yield*/, Deno.readFile(filename)];
                case 1: return [2 /*return*/, _b.apply(_a, [_c.sent()])];
            }
        });
    });
}
//# sourceMappingURL=read_file_str.js.map

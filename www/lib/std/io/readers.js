...
var StringReader = /** @class */ (function () {
    function StringReader(s) {
        this.s = s;
        this.offs = 0;
        this.buf = new Uint8Array(encode(this.s));
    }
    StringReader.prototype.read = function (p) {
        return __awaiter(this, void 0, void 0, function () {
            var n;
            return __generator(this, function (_a) {
                n = Math.min(p.byteLength, this.buf.byteLength - this.offs);
...
var MultiReader = /** @class */ (function () {

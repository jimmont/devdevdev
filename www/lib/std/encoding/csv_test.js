    ...
    Deno.test({
        ...
        fn: function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                var comma, comment, fieldsPerRec, trim, lazyquote, actual, err, e_1, expected;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            if (!t.Error) return [3 /*break*/, 5];
                            err = void 0;
                            _c.label = 1;
                        case 1:
                            _c.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, readMatrix(new BufReader(new StringReader((_a = t.Input) !== null && _a !== void 0 ? _a : "")), {
                                    comma: comma,
                                    comment: comment,
                        ...
                        case 4:
                            ...
                            return [3 /*break*/, 7];
                        case 5: return [4 /*yield*/, readMatrix(new BufReader(new StringReader((_b = t.Input) !== null && _b !== void 0 ? _b : "")), {
                                comma: comma,
                                comment: comment,
                                trimLeadingSpace: trim,
                                fieldsPerRecord: fieldsPerRec,
        ...
        fn: function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, parse(testCase["in"], {
...
for (var _a = 0, parseTestCases_1 = parseTestCases; _a < parseTestCases_1.length; _a++) {
    var testCase = parseTestCases_1[_a];
    _loop_2(testCase);
}

...
Deno.test({
    ...
    fn: function () {
        for (var _i = 0, testCases_1 = testCases; _i < testCases_1.length; _i++) {
            var _a = testCases_1[_i], bin = _a[0], b32 = _a[1];
...
Deno.test({
    ...
    fn: function () {
        for (var _i = 0, testCases_2 = testCases; _i < testCases_2.length; _i++) {
            var _a = testCases_2[_i], bin = _a[0], b32 = _a[1];
...
Deno.test({
    ...
    fn: function () {
        ...
        try {
            ...
            assert(e.message.includes("Invalid string. Length must be a multiple of 8"));
            errorCaught = true;
        }
        assert(errorCaught);
    }
...
//# sourceMappingURL=base32_test.js.map
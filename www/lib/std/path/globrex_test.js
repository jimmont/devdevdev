...
function match(glob, strUnix, strWin, opts) {
    ...
    var regex = globrex(glob, opts).regex;
    var match = (isWin && strWin ? strWin : strUnix).match(regex);
...
test({
    ...
    fn: function () {
        ...
        t.equal(match("u*orn", "unicorn", { flags: "g" }), true, "match the middle");
        t.equal(match("ico", "unicorn"), false, "do not match without g");
        t.equal(match("ico", "unicorn", { flags: "g" }), true, 'match anywhere with RegExp "g"');
        t.equal(match("u*nicorn", "unicorn"), true, "match zero characters");
        t.equal(match("u*nicorn", "unicorn", { flags: "g" }), true, "match zero characters");
    }
});
test({
    name: "globrex: advance * matching",
    fn: function () {
        t.equal(match("*.min.js", "http://example.com/jquery.min.js", {
            globstar: false
        }), true, "complex match");
        t.equal(match("*.min.*", "http://example.com/jquery.min.js", { globstar: false }), true, "complex match");
        t.equal(match("*/js/*.js", "http://example.com/js/jquery.min.js", {
            globstar: false
        }), true, "complex match");
        ...
        t.equal(match("/js*jq*.js", "http://example.com/js/jquery.min.js", {
            flags: "g"
        }), true);
    }
});
test({
    ...
    fn: function () {
        ...
        var tester = function (globstar) {
            t.equal(match("f?o", "foo", { extended: true, globstar: globstar, flags: "g" }), true);
            t.equal(match("f?o", "fooo", { extended: true, globstar: globstar, flags: "g" }), true);
            t.equal(match("f?o?", "fooo", { extended: true, globstar: globstar, flags: "g" }), true);
            t.equal(match("?fo", "fooo", { extended: true, globstar: globstar, flags: "g" }), false);
            t.equal(match("f?oo", "foo", { extended: true, globstar: globstar, flags: "g" }), false);
            t.equal(match("foo?", "foo", { extended: true, globstar: globstar, flags: "g" }), false);
        };
        tester(true);
        tester(false);
    }
...
test({
    ...
    fn: function () {
        ...
        var tester = function (globstar) {
            t.equal(match("fo[oz]", "foo", { extended: true, globstar: globstar, flags: "g" }), true);
            t.equal(match("fo[oz]", "foz", { extended: true, globstar: globstar, flags: "g" }), true);
            t.equal(match("fo[oz]", "fog", { extended: true, globstar: globstar, flags: "g" }), false);
        };
        tester(true);
        tester(false);
    }
...
test({
    ...
    fn: function () {
        ...
        var tester = function (globstar) {
            t.equal(match("foo{bar,baaz}", "foobaaz", {
                extended: true,
                globstar: globstar,
                flag: "g"
            }), true);
            t.equal(match("foo{bar,baaz}", "foobar", {
                extended: true,
                globstar: globstar,
                flag: "g"
            }), true);
            t.equal(match("foo{bar,baaz}", "foobuzz", {
                extended: true,
                globstar: globstar,
                flag: "g"
            }), false);
            t.equal(match("foo{bar,b*z}", "foobuzz", {
                extended: true,
                globstar: globstar,
                flag: "g"
            }), true);
...
test({
    ...
    fn: function () {
        ...
        var tester = function (globstar) {
            t.equal(match("http://?o[oz].b*z.com/{*.js,*.html}", "http://foo.baaz.com/jquery.min.js", { extended: true, globstar: globstar, flags: "g" }), true);
            t.equal(match("http://?o[oz].b*z.com/{*.js,*.html}", "http://moz.buzz.com/index.html", { extended: true, globstar: globstar, flags: "g" }), true);
            t.equal(match("http://?o[oz].b*z.com/{*.js,*.html}", "http://moz.buzz.com/index.htm", { extended: true, globstar: globstar, flags: "g" }), false);
            t.equal(match("http://?o[oz].b*z.com/{*.js,*.html}", "http://moz.bar.com/index.html", { extended: true, globstar: globstar, flags: "g" }), false);
            t.equal(match("http://?o[oz].b*z.com/{*.js,*.html}", "http://flozz.buzz.com/index.html", { extended: true, globstar: globstar, flags: "g" }), false);
        };
        tester(true);
        tester(false);
    }
...
test({
    ...
    fn: function () {
        var tester = function (globstar) {
            t.equal(match("http://foo.com/**/{*.js,*.html}", "http://foo.com/bar/jquery.min.js", { extended: true, globstar: globstar, flags: "g" }), true);
            t.equal(match("http://foo.com/**/{*.js,*.html}", "http://foo.com/bar/baz/jquery.min.js", { extended: true, globstar: globstar, flags: "g" }), true);
            t.equal(match("http://foo.com/**", "http://foo.com/bar/baz/jquery.min.js", {
                extended: true,
                globstar: globstar,
                flags: "g"
            }), true);
...
test({
    ...
    fn: function () {
        var tester = function (globstar) {
            ...
            t.equal(match(testExtStr, testExtStr, { extended: true, globstar: globstar, flags: "g" }), true);
        };
        tester(true);
        tester(false);
    }
...
test({
    ...
    fn: function () {
        ...
        t.equal(match("*(foo|bar)/**/*.txt", "foo/hello/world/bar.txt", {
            extended: true,
            globstar: true
        }), true);
        t.equal(match("*(foo|bar)/**/*.txt", "foo/world/bar.txt", {
            extended: true,
            globstar: true
        }), true);
    }
...
test({
    ...
    fn: function () {
        t.equal(match("**/*/?yfile.{md,js,txt}", "foo/bar/baz/myfile.md", {
            extended: true
        }), true);
...
//# sourceMappingURL=globrex_test.js.map
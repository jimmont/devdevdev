...
test({
    ...
    fn() {
        ...
        assertEquals(formatted === "[Function anonymous]" || formatted === "[Function val]", true);
    }
});
test({
...
test({
    ...
    fn() {
        ...
        assertEquals(format(obj, { escapeRegex: true }), 'Object {\n  "test": /regexp\\\\d/gi,\n}');
    }
});
test({
...
test({
    ...
    fn() {
        const indent = 0;
        assertEquals(format(createVal(), { indent }), createExpected().replace(/ {2}/g, " ".repeat(indent)));
    }
});
test({
...
test({
    ...
    fn() {
        ...
        assertEquals(format(v, { maxDepth: 2 }), [
            "Array [",
            "  Object {",
